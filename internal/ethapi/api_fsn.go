...
// GetTimeLockValue wacom
func (s *PublicFusionAPI) GetTimeLockValue(ctx context.Context, assetID common.Hash, address common.Address, startTime, endTime uint64, blockNr rpc.BlockNumber) (string, error) {
